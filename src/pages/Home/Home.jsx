...
export default function Home(){
    ...
    const generateResponse=(input)=>{
        const resposne=data.find(item=>input.toLowerCase()==item.question.toLowerCase());
        let answer= "Sorry, But I can't Answer this as I have answers to specific questions"
        if(resposne !=undefined){
            answer=resposne.response;
        }
